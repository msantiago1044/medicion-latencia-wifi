...
function App() {
  ...
  useEffect(() => {
    ...
    // Cargar estado de instrucciones minimizadas
    const savedMinimized = localStorage.getItem('instructionsMinimized')
    if (savedMinimized !== null) {
      setIsInstructionsMinimized(savedMinimized === 'true')
    }
  }, [])
  ...
  // Guardar estado de instrucciones
  useEffect(() => {
    localStorage.setItem('instructionsMinimized', isInstructionsMinimized)
  ...
  return (
    <div className="app">
      ...
      {/* Panel de instrucciones MINIMIZABLE */}
      <div className={`info-panel ${isInstructionsMinimized ? 'minimized' : ''}`}>
        <div className="info-panel-header" onClick={() => setIsInstructionsMinimized(!isInstructionsMinimized)}>
          <h4>📖 Instrucciones</h4>
